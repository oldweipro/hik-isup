...
import com.oldwei.isup.sdk.service.impl.*;
...
public class StartedUpRunner implements ApplicationRunner, DisposableBean {
    ...
    public void run(ApplicationArguments args) throws Exception {
         ...
         * 存储信息回调
         */
        pSSListenParam.fnSSMsgCb = new PSSMessageCallback();
         ...
         */
        //存储信息回调
        pSSListenParam.fnSStorageCb = new PSSStorageCallback();
        //读写扩展回调
...
//        pSSListenParam.fnSSRWCbEx = fEHomeSSRWCallBackEx;
        ...
        net_ehome_alarm_listen_param.fnMsgCb = new AlarmMsgCallBack();
